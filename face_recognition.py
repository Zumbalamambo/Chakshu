...
known_faces, known_face_encodings = scan_known_people("./images")
...
while True:
    ...
    if process_this_frame:
        ...
        for face_encoding in face_encodings:
            ...
            match = face_recognition_api.compare_faces(known_face_encodings, face_encoding)

            if True in match:
                for is_match, r_name in zip(match, known_faces):
                    if is_match:
                        name = r_name
            else:
                name = "Unknown"
